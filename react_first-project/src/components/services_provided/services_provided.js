import classes from './services_provided.module.css';
			...
			<div className={classes.services_provided_block}>
				<div>
					...
					<p>
						...
						Suspendisse justo sem, molestie tincidunt  Maecenas est risus, tristique volutpat sagittis vel,
							feugiat consectetur diam. Suspendisse justo sem, molestie tincidunt
					</p>
				</div>
				<div>
